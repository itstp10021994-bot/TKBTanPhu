...
Ghi nhớ lưu trên trình duyệt (localStorage + cookie) và mã `?dn=...` trên địa chỉ
trang. Mở **địa chỉ gốc** của app (VD `https://tkbtanphu.streamlit.app/`) thì trình
duyệt tự gắn lại `?dn=` và đăng nhập luôn — không cần nhập mã, không cần bookmark. Không gửi địa chỉ
